...
const sv = {
  ...
  endlessVardtradStanding: "{n} vårdträd kvar på sin post",
  ...
  statDps: "DPS",
  statIncome: "Inkomst",
  auraBoostTitle: "Förstärkt av närliggande torn",
  targetLabel: "Mål",
  targetAria: "Val av mål",
  targetFirst: "Främst i ledet",
  targetLast: "Sist i ledet",
  targetStrongest: "Mest liv",
  targetWeakest: "Minst liv",
  tilesUnit: "{n} rutor",
  levelOf: "Nivå {l}/{m}",
...
const en: Record<StringKey, string> = {
  ...
  endlessVardtradStanding: "{n} guardian trees still at their post",
  ...
  statDps: "DPS",
  statIncome: "Income",
  auraBoostTitle: "Boosted by nearby towers",
  targetLabel: "Target",
  targetAria: "Targeting",
  targetFirst: "Front of the line",
  targetLast: "Back of the line",
  targetStrongest: "Most health",
  targetWeakest: "Least health",
  tilesUnit: "{n} tiles",
  levelOf: "Level {l}/{m}",
